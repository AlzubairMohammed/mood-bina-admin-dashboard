<template>
  <form ref="form" class="w-full p-4" @submit.prevent="updateProduct()">
...
div class="floating-input mb-5 relative">
 ...
 <div class="floating-input mb-5 relative">
    ...
    <select
      ...
      "
    >
      <option :value="sub_section_id" v-for="category in allCategories" :key="category.id">{{category.name}}</option>
    </select>
<div class="drag py-2">
  <label
      for="countries"
